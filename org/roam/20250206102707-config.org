	    ...
	    (progn
	      (org-roam-set-keyword
	       ...
	       (concat ":"
		       ...
		       "@todo:"))
	      (message "Todo marking: Marked todo for %s"
		       (org-roam-node-title (org-roam-node-at-point))))

	  (if (not (my-org-has-todo))
	      (progn
		(org-roam-set-keyword
		 "filetags"
		 (concat ":"
			 (string-join (delete "@todo" (org-roam-node-tags (org-roam-node-at-point))) ":")
			 ":"))
		(message "Todo marking: Removed todo for %s"
			 (org-roam-node-title (org-roam-node-at-point)))))))))
#+end_src
***** Setup hooks
****** ~find-file-hook~
...
(setq org-agenda-custom-commands
      '(("cm" "Custom: Mcity"
	 ((org-ql-block '(and (todo) (tags "@mcity"))
